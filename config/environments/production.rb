Rails.application.configure do
  ...
  # Store the Rack-level HTTP Cache in Redis
  ...
  config.cache_store = :redis_store, 'redis://localhost:6379/0/breakbeat-rails-cache'
  ...
  config.action_controller.asset_host = "http://assets.status.telvue.com"
